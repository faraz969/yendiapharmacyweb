...
@section('page-title', 'Prescriptions - ' . $branch->name)

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><i class="fas fa-prescription me-2"></i>All Prescriptions - {{ $branch->name }}</h5>
    </div>
    <div class="card-body">
            <!-- Filters -->
            <form method="GET" action="{{ route('branch.prescriptions.index') }}" class="mb-4">
                <div class="row g-3">
                    <div class="col-md-8">
                    ...
                    <tbody>
                        @forelse($prescriptions as $prescription)
                            <tr>
                                ...
                                <td>{{ $prescription->user->name ?? 'Guest' }}</td>
                                <td>
                                    @php
                                        $badgeColors = [
                                            'pending' => 'warning',
                                ...
                                <td>
                                    <a href="{{ route('branch.prescriptions.show', $prescription->id) }}" class="btn btn-sm btn-primary">
