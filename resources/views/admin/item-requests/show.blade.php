...
<div class="row">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <strong>Branch:</strong> {{ $itemRequest->branch->name ?? 'N/A' }}
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.item-requests.update-status', $itemRequest->id) }}" method="POST">
                    @csrf
                    <div class="mb-3">
...
<div class="mt-3">
    <div class="d-flex justify-content-between">
        <a href="{{ route('admin.item-requests.index') }}" class="btn btn-secondary">
            <i class="fas fa-arrow-left me-2"></i>Back to Item Requests
        </a>
        <form action="{{ route('admin.item-requests.destroy', $itemRequest->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this item request? This action cannot be undone.');">
            @csrf
            @method('DELETE')
            <button type="submit" class="btn btn-danger">
                <i class="fas fa-trash me-2"></i>Delete Item Request
            </button>
        </form>
    </div>
</div>
