...
@section('title', 'Create App Notice')
@section('page-title', 'Create App Notice')

@section('content')
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><i class="fas fa-plus me-2"></i>Create New App Notice</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('admin.app-notices.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
