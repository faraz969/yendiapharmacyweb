...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth', 'admin'])->group(function () {
        ...
        Route::get('/products/bulk-images/template', [ProductController::class, 'downloadBulkImagePathsTemplate'])->name('products.bulk-images.template');
        Route::post('/products/bulk-images', [ProductController::class, 'bulkUpdateImagePaths'])->name('products.bulk-images.store');
